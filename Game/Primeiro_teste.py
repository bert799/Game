...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, player_img, row, column, platforms, blocks):
        ...
        player_sheet = pygame.transform.scale(player_img, (PLAYER_WIDTH, PLAYER_HEIGHT))
...
def load_assets(img_dir):
    assets = {}
    assets[PLAYER_IMG] =  player_img = pygame.image.load(path.join(img_dir, 'Oldhero.png')).convert_alpha()
